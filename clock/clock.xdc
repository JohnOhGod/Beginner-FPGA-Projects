##Accurate for Nexys A7 100T. Other FPGAs may need different constraints.
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { kilo }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
